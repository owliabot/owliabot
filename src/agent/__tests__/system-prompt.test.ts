...
describe("system-prompt", () => {
  describe("buildSystemPrompt", () => {
    ...
    it("should include memory section in direct chats", () => {
      const ctx: PromptContext = {
        workspace: {
    ...
    it("should NOT include memory section in group chats (security boundary)", () => {
      const ctx: PromptContext = {
        workspace: {
          memory: "User likes DeFi projects",
        },
    ...
    it("should NOT include memory section in channel chats (security boundary)", () => {
      const ctx: PromptContext = {
        workspace: {
          memory: "User likes DeFi projects",
        },
    ...
    it("should include all sections when all are present (direct chat)", () => {
      const ctx: PromptContext = {
        workspace: {
